        ...
        <article>
          <div className="desc full">
            ...
            <p>
              ...
              combined.After World War II, crime rates increased in the United States, peaking from the 1980s to the early-1990s. 
              Violent crimes nearly quadrupled between 1960 and peaked around 1991. Since the 1990s, however, contrary to popular belief, 
              crime in the United States has declined steadily.  By bringing together the available data, the research and analysis contained in the
               study can be used to learn, understand and strengthen prevention.
